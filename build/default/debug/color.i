...
# 132 "color.c"
    ...
    rgb_comp[0] = sqrtf(powf((red_r - 0.747),2) + powf((green_r - 0.071),2) + powf((blue_r - 0.120),2));
    ...
    rgb_comp[5] = sqrtf(powf((red_r - 0.664),2) + powf((green_r - 0.110),2) + powf((blue_r - 0.160),2));
